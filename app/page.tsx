    ...
    <>
      ...
      <section className="relative py-5 bg-[#111827] bg-[url('/stars.png')] bg-repeat">
        ...
        >
          ...
          <p className="text-2xl mt-3 text-gray-600 dark:text-gray-300 leading-relaxed">
      ...
      <section className="relative py-20 bg-gradient-to-b from-[#1b1b1d] via-[#111827] to-[#111827]">
      ...
      <section className="relative bg-gradient-to-b from-[#111827] via-[#0f172a] to-[#0e1a2f]">
